...
"[project]/src/app/order/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const socket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$socket$2e$io$2d$client$2f$build$2f$esm$2d$debug$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["io"])(`http://${("TURBOPACK compile-time value", "localhost")}:5000`);
function Order() {
    ...
    const loadTasks = async ()=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`http://${("TURBOPACK compile-time value", "localhost")}:5000/tasks`);
    ...
    const addTask = async ()=>{
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`http://${("TURBOPACK compile-time value", "localhost")}:5000/tasks`, formData);
        setFormData({
            category: 'BK',
            number: ''
        });
    ...
    const finishTask = async (taskId)=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`http://${("TURBOPACK compile-time value", "localhost")}:5000/tasks/finish`, {
            task_id: taskId
        });
    };
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1134cf2b._.js.map